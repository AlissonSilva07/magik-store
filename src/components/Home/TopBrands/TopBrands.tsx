  ...
  return (
    <section className="w-full p-4 md:p-8 flex flex-col items-center gap-4 md:gap-8">
        ...
        <div className='w-full grid grid-cols-2 grid- lg:grid-cols-4 gap-4 justify-items-center items-center'>
            <img src={Byilaclesen} alt="biylaclesen" className='w-[140px] md:w-[220px] lg:w-[240px] self-center' />
            <img src={Fjall} alt="fjallraven" className='w-[140px] md:w-[220px] lg:w-[240px] self-center' />
            <img src={SD} alt="sandisk" className='w-[140px] md:w-[220px] lg:w-[240px] self-center' />
            <img src={WD} alt="wd" className='w-[140px] md:w-[220px] lg:w-[240px] self-center' />
        </div>
    </section>
  );
}

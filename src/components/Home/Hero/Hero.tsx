...
export function Hero() {
  return (
    <div className='pt-20 flex flex-col lg:flex-row items-center'>
      <img src={HeroImg} alt="A woman carrying bags and pointing to her left side." className='w-full h-[427px] md:h-[449px] lg:w-1/2 lg:h-[692px] object-cover border-b lg:border-r border-cinza-border/20' />
      <div className='relative flex p-4 md:p-8 flex-col items-center gap-4 z-30'>
        ...
        <img src={LogoReduced} alt="Magik!" className='absolute hidden select-none opacity-10 lg:block h-96 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10' />
      </div>
    </div>
  );
}

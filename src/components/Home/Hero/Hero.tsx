...
export function Hero() {
  return (
    <div className='pt-20 flex flex-col lg:flex-row items-center'>
      <img src={HeroImg} alt="A woman carrying bags and pointing to her left side." className='w-full h-[280px] md:h-[380px] lg:w-1/2 lg:h-[680px] object-cover lg:border-b lg:border-r lg:border-cinza-border/20' />
